...
import pro.getline.vpn.log.LogcatCache
import pro.getline.vpn.log.LogcatWriter
...
class LogcatService : Service(), CoroutineScope by CoroutineScope(Dispatchers.Default), IInterface {
    ...
    private fun createNotificationChannel() {
        NotificationManagerCompat.from(this)
            .createNotificationChannel(
                ...
                ).setName(getString(pro.getline.vpn.design.R.string.clash_logcat)).build()
            )
    }
    ...
    private fun showNotification() {
        val notification = NotificationCompat
            ...
            .setSmallIcon(pro.getline.vpn.service.R.drawable.ic_logo_service)
            .setColor(getColorCompat(pro.getline.vpn.design.R.color.color_clash_light))
            .setContentTitle(getString(pro.getline.vpn.design.R.string.clash_logcat))
            .setContentText(getString(pro.getline.vpn.design.R.string.running))
            .setContentIntent(
