...
class SubscriptionStateHolder {
     ...
     * Captured by the host at [beginInitialLoad]/[beginRefresh] and passed back to
     * [onRequestCancelled] / [applyLocalResult] so superseded jobs are ignored.
     */
     ...
     * Loading with no in-flight request should fetch.
     */
    fun needsInitialLoad(): Boolean {
        ...
        return when (state) {
            ...
            is SubscriptionUiState.Failed -> false
        }
    }
