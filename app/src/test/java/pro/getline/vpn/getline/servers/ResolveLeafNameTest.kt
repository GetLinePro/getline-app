...
import pro.getline.vpn.core.model.Proxy
...
class ResolveLeafNameTest {
    ...
    fun leafChildIsReturnedDirectly() {
        ...
        val leaf = VpnServerSelectionRepository.resolveLeafName("Авто") { graph[it] }
    ...
    fun descendsThroughAnIntermediateGroup() {
        ...
        val leaf = VpnServerSelectionRepository.resolveLeafName("Youtube") { graph[it] }
    ...
    fun descendsThroughSeveralGroups() {
        ...
        assertEquals("leaf", VpnServerSelectionRepository.resolveLeafName("A") { graph[it] })
    }
    ...
    fun cycleYieldsNothingRatherThanLooping() {
        ...
        assertNull(VpnServerSelectionRepository.resolveLeafName("A") { graph[it] })
    }
    ...
    fun chainDeeperThanTheCapYieldsNothing() {
        ...
        assertNull(VpnServerSelectionRepository.resolveLeafName("g0") { graph[it] })
    }
    ...
    fun chainWithinTheCapResolves() {
        ...
        assertEquals("leaf", VpnServerSelectionRepository.resolveLeafName("g0") { graph[it] })
    }

    @Test
    fun missingGroupYieldsNothing() {
        assertNull(VpnServerSelectionRepository.resolveLeafName("A") { null })
    }
    ...
    fun unknownChildIsReportedAsIs() {
        ...
        assertEquals("mystery", VpnServerSelectionRepository.resolveLeafName("A") { graph[it] })
    }
